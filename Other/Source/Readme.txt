...
user in an INI file next to EverythingPortable.exe called EverythingPortable.ini.
...
copy AppNamePortable.ini from this directory to EverythingPortable.ini next to
EverythingPortable.exe. The options in the INI file are as follows:
